...
# Construct the co-authorship bipartite network
...
# Select the main connected component
...
# Create the hypergraph in which nodes are authors and each hyperedge links the authors of a same paper
# Discard the hyperedges of sizes 1 and 5
...
# Inspect the values of the estimated probabilities of hyperedges occurrance
res_rand$B          # Estimates for the probability of occurrance of an hyperedge


## 3. Comparison with two other methods

# Compare our approach with the spectral clustering algorithm
